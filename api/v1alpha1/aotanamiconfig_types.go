...
// AotanamiConfigSpec defines the desired state of AotanamiConfig.
// AotanamiConfig is the global configuration resource for the Aotanami operator.
// Only one AotanamiConfig resource should exist per cluster.
type AotanamiConfigSpec struct {
...
// AotanamiConfig is the Schema for the aotanamiconfigs API.
// It is the global configuration resource for the Aotanami operator.
type AotanamiConfig struct {
	...
	// +required
	Spec AotanamiConfigSpec `json:"spec"`

	// +optional
	Status AotanamiConfigStatus `json:"status,omitzero"`
}

// +kubebuilder:object:root=true

// AotanamiConfigList contains a list of AotanamiConfig
type AotanamiConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitzero"`
	Items           []AotanamiConfig `json:"items"`
}

func init() {
	SchemeBuilder.Register(&AotanamiConfig{}, &AotanamiConfigList{})
}
