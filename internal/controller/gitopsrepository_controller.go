...
// +kubebuilder:rbac:groups=aotanami.zelyo.ai,resources=gitopsrepositories,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=aotanami.zelyo.ai,resources=gitopsrepositories/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=aotanami.zelyo.ai,resources=gitopsrepositories/finalizers,verbs=update

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
// TODO(user): Modify the Reconcile function to compare the state specified by
// the GitOpsRepository object against the actual cluster state, and then
